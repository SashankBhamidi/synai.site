      ...
      const response = await fetch('https://api.openai.com/v1/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: 'system',
              content: 'You are Synthesis AI, a helpful AI assistant. You remember previous messages in our conversation and can refer to them. Always identify yourself as Synthesis AI, never as ChatGPT, GPT or any other name. Provide varied and thoughtful responses.'
            },
            ...openaiMessages
          ],
